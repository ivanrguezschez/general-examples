...
public class ProvinciaSort {
    ...
    static final Comparator PROVINCIA_CODIGO_ORDER_ASC = new Comparator() {
        public int compare(Object o1, Object o2) {
            return Integer.valueOf(((Provincia) o1).getCodigo()).compareTo(
                    Integer.valueOf(((Provincia) o2).getCodigo()));
        }
    };

    static final Comparator PROVINCIA_CODIGO_ORDER_DES = new Comparator() {
        public int compare(Object o1, Object o2) {
            return Integer.valueOf(((Provincia) o2).getCodigo()).compareTo(
                    Integer.valueOf(((Provincia) o1).getCodigo()));
        }
    };

    static final Comparator PROVINCIA_NOMBRE_ORDER_ASC = new Comparator() {
        public int compare(Object o1, Object o2) {
            return ((Provincia) o1).getNombre().compareToIgnoreCase(
                    ((Provincia) o2).getNombre());
        }
    };

    static final Comparator PROVINCIA_NOMBRE_ORDER_DES = new Comparator() {
        public int compare(Object o1, Object o2) {
            return ((Provincia) o2).getNombre().compareToIgnoreCase(
                    ((Provincia) o1).getNombre());
        }
    };

    public static void main(String[] args) {
        List provincias = Arrays.asList(PROVINCIAS);
